...
# -*- coding: utf-8 -*-
"""
Forerunners Roadmap Excel Generator
Auto-generates roadmap and indicators Excel file
"""
...
indicators_data = {
    ...
    "Indicator Name": [
        ...
        "Digital use for business/learning",
        "Well-being improvement",
        "Household income stability",
        "Youth/women leadership roles",
        "Green enterprise survival",
        "Digitally active community networks"
    ],
    "Definition": [
    ...
    "Target 2027": [
        3000, 20, 60,
        0.60, 0.35, 0.25, 0.40, 0.50,
        0.55, 80, 0.60, 20
    ],
    "Target 2028": [
        6000, 40, 120,
        0.70, 0.45, 0.40, 0.55, 0.60,
        0.65, 150, 0.70, 40
    ],
    "Target 2029": [
        9000, 60, 180,
        0.75, 0.55, 0.50, 0.65, 0.65,
        0.70, 220, 0.75, 60
    ]
}
...
output_path = output_dir / "Forerunners_Roadmap_and_Indicators_2026-2029.xlsx"

with pd.ExcelWriter(output_path, engine="openpyxl") as writer:
    df_roadmap.to_excel(writer, sheet_name="Roadmap Table", index=False)
    df_indicators.to_excel(writer, sheet_name="Indicators", index=False)

print(f"✅ Excel file generated: {output_path}")
print(f"   - Sheet 1: Roadmap Table ({len(df_roadmap)} products)")
print(f"   - Sheet 2: Indicators ({len(df_indicators)} indicators)")
